...
void perform_calculations(double change_amount, int &amount_of_quarters, int &amount_of_dimes,
                          int &amount_of_nickels, int &amount_of_pennies);
void output_results(double change_amount, int amount_of_quarters, int amount_of_dimes,
                    int amount_of_nickels, int amount_of_pennies);
...
int main()
{
    ...
    perform_calculations(change_amount, amount_of_quarters,
                         amount_of_dimes, amount_of_nickels,
                         amount_of_pennies);
    output_results(change_amount, amount_of_quarters,
                   amount_of_dimes, amount_of_nickels,
                   amount_of_pennies);
    return 0;
}
...
{
    std::cout << std::endl;
    std::cout << std::fixed << std::setprecision(2) << "$" << change_amount
              << " can be created using" << std::endl;
