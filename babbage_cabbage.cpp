...
#define OVERTIME_CUTOFF_HOURS 60
#define MIN_PAY 7.25
...
void calc_gross_pay(double regular_hours,double overtime_hours, double hourly_rate, double &gross_pay)
{
    gross_pay = (regular_hours * hourly_rate) + (overtime_hours * (hourly_rate * OVERTIME_PAY_RATE));
}
...
// Module for calculating net pay and tax witholding
...
void output(std::string full_name, double regular_hours, double overtime_hours, double hourly_rate, double gross_pay, double taxes, double net_pay)
{
    std::cout << std::endl;
    std::cout << "                      Reg    Ovt    Hourly  Gross                    Net" << std::endl;
    std::cout << "Name                  Hours  Hours  Rate    Pay      Taxes   Deduct  Pay" << std::endl;
    std::cout << "====================  =====  =====  ======  =======  ======  ======  =======" << std::endl;
    std::cout << std::left << std::setw(20) << full_name  << "  "
    << std::right << std::fixed << std::setprecision(2) << std::setw(5) << regular_hours << "  " << std::setw(5) << overtime_hours << "  "
    << std::setw(6) << hourly_rate << "  "<< std::setw(7) << gross_pay << "  "
    << std::setw(6) << taxes << "  " << std::setw(6) << PARKING_FEE << "  "
...
void input(std::string &full_name, double &hours, double &hourly_rate)
{
    ...
    input_bounded_value("number of hours worked", MIN_WORK_HOURS, OVERTIME_CUTOFF_HOURS, hours);
    input_bounded_value("hourly pay rate", MIN_PAY, MAX_PAY, hourly_rate);
}
...
int main()
{
    ...
    double hours, regular_hours, overtime_hours, hourly_rate, gross_pay, taxes, net_pay;
    do{
    std::cout << std::endl;
